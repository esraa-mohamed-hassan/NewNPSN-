                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="col-sm-12 col-md-12 col-lg-12 col-xl-12 needs-validation" novalidate
                                    ...
                                    <select class="col-sm-10 col-md-8 col-lg-6 col-xl-10  selectpicker"
                                        ...
                                        @foreach ($event_types as $event_type)
                                            <option value="{{ $event_type->name }}" title="{{ $event_type->name }}"
                                                {{ $recording_event->event_type == $event_type->name ? 'selected' : '' }}
                                ...
                                <div class="form-group mb-3 col-xl-7" style="margin-right: -1.85%;">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input style="border-right: none;" class="form-control"
                                            data-date-format="yyyy-mm-dd" value="{{ $recording_event->date }}" required
                                ...
                                <br>
                                <div class="form-group mb-3">
                                    <label for="{{ __('lang.special_entity') }}">{{ __('lang.special_entity') }}</label>
                                    <textarea rows="4" cols="50" class="form-control" id="mytextarea"
                                        name="special_entity"
                                        required>{{ html_entity_decode($recording_event->special_entity) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                        {{ __('lang.please_choose') . __('lang.special_entity') }}.
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <label for="{{ __('lang.event') }}">{{ __('lang.event') }}</label>
                                    <textarea rows="4" cols="50" class="form-control" id="event" name="event"
                                        required>{{ html_entity_decode($recording_event->event) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                        {{ __('lang.please_choose') . __('lang.event') }}.
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <label for="{{ __('lang.procedures') }}">{{ __('lang.procedures') }}</label>
                                    <textarea rows="4" cols="50" class="form-control" id="procedures" name="procedures"
                                        required>{{ html_entity_decode($recording_event->procedures) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                        {{ __('lang.please_choose') . __('lang.procedures') }}.
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <label
                                        for="{{ __('lang.result_recording_event') }}">{{ __('lang.result_recording_event') }}</label>
                                    <textarea rows="4" cols="50" class="form-control" id="result" name="result"
                                        required>{{ html_entity_decode($recording_event->result) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                        {{ __('lang.please_choose') . __('lang.result_recording_event') }}.
                                    </div>
                                </div>
