                    ...
                    <div class="card card_print">
                        <div class="card-header noprint_content">
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <p class="center_p">
                                        <u>{{ __('lang.report_incoming_communication') }}</u>
                                        <br>
                        ...
                        <div class="card-header print_content">
                            ...
                            <p class="centerprint_p print_content">
                                <u>{{ __('lang.report_incoming_communication') }}
                                    <br>
                                    <span>تاريخ 9 سبتمبر 2021 إلى تاريخ 9 سبتمبر 2021</span>
                                </u>
                            ...
                            <table class="table table-responsive-sm table-striped table-bordered incomingReports_datatable">
                                <thead>
                                    <tr class="incoming_tr">
                                        ...
                                        {{-- <th style="width: 15%">{{ __('lang.procedure_npsn2') }}</th> --}}
                                ...
                                <tbody>
                                    ...
                                    @foreach ($all_data as $key => $data)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center text-data"> {!! rtrim($data->subject) !!} </td>
                                            <td class="text-center text-data"> {!! rtrim($data->procedures_npsn) !!} </td>
                                            <td class="text-center text-data"> {!! rtrim($data->procedures_authorities) !!} </td>
                                            <td class="text-center text-data"> {!! rtrim($data->result) !!} </td>
                                        </tr>
