...
<link href="{{ asset('css/bootstrap-select1.12.2.min.css') }}" rel="stylesheet">
    <style>
        ...
        #inquiries_communications_datatable_filter {
            display: none;
        }

        #inquiries_communications_datatable_length {
            display: none;
        }
                ...
                <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-xl-6">
                                    <i class="fa fa-align-justify"></i>{{ __('lang.inquiries_communications') }}
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="col-sm-12 col-md-12 col-lg-12 col-xl-12 needs-validation" novalidate action=""
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="{{ __('lang.entity') }}"
                                            style="margin-left: 2%;">{{ __('lang.entity') }}</label>
                                        <br>
                                        <select class="col-sm-10 col-md-8 col-lg-6 col-xl-10 selectpicker"
                                            data-live-search="true" name="entity" id="entity"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input style="border-right: none;" class="form-control datepicker"
                                                data-date-format="yyyy-mm-dd" name="from_date" id="from_date" placeholder="{{ __('lang.inqury_from_date') }}">
                                        </div>
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input style="border-right: none;" class="form-control datepicker"
                                                data-date-format="yyyy-mm-dd" name="to_date" id="to_date" placeholder="{{ __('lang.inqury_to_date') }}">
                                        </div>
                                        <div class="valid-feedback">
                                            {{ __('lang.looks_good') }}
                                        </div>
                        ...
                        <div class="card-body hr_hide">
                            ...
                            <table class="table table-responsive-sm table-striped inquiries_communications_datatable"
                                id="inquiries_communications_datatable" style="display: none;">
                                <thead>
                                    <tr class="incoming_tr">
                                        <th style="width: 2%!important;">{{ __('lang.id') }}</th>
                                        <th style="width: 7%!important;">{{ __('lang.entity') }}</th>
                                        <th style="width: 7%!important;">{{ __('lang.date_incoming_reports') }}</th>
                                        <th style="width: 5%!important;">{{ __('lang.time_incoming_reports') }}</th>
                                        <th style="width: 30%!important;">{{ __('lang.subject_incoming_reports') }}</th>
                                        <th style="width: 10%!important;">{{ __('lang.procedure_npsn2') }}</th>
                        ...
                        <div class="card-header header_buttons hr_hide">
                            <div class="row">
                                <div class="col-xl-6">
                                    <form id="form_printer" action="{{ route('inquiryCommunications.print') }}"
                                        method="POST">
                                        @csrf
                                ...
                                <div class="col-xl-6">
                                    <form id="inquiry_form2" action="{{ route('inquiryCommunications.pdf') }}"  method="POST">
                                        ...
                                        @csrf
                                    <button type="submit" class="w-100 btn btn-danger btn_pdf">
...
<script src="{{ asset('js/bootstrap-select1.12.2.min.js') }}"  ></script>
    ...
    <script >
        ...
        $("#btn-printer").click(function(event) {
            var allData = [];
            var data_table = $("#inquiries_communications_datatable").dataTable().fnGetData();
        ...
        $("#btn_inqury").click(function(event) {
            ...
            $('#inquiries_communications_datatable').hide();
            $('#inquiries_communications_datatable').show();
            $('.hr_hide').show();
            $.ajax({
                url: "{{ route('inquiryCommunications.store') }}",
                "type": "POST",
                headers: {
