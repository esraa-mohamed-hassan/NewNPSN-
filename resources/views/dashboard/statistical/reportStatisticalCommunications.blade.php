...
@section('content')
    ...
    <div class="form-group col-xl-12 text-center title_header1">
        <strong>{{ __('lang.statistical_communications') }}</strong>
    </div>

    <input type="hidden" name="data" id="data_print">

    <div class="card-body">
        <table class="table table-responsive-sm table-bordered table-striped statisticalCommunications_datatable"
...
@section('javascript')
    <script>
        $(document).ready(function() {
            ...
            var table = $('.statisticalCommunications_datatable').DataTable({
                ...
                buttons: [{
                    ...
                    title: '<div class="title_header"><strong> {{ __('lang.statistical_communications') }} </strong></div>',
                ...
                processing: true,
                ajax: "{{ route('statisticalCommunications.index') }}",
                columns: [{
                        data: 'entity',
                        name: 'entity',
                        orderable: false
            ...
            setTimeout(function() {
                ...
                var statisticalCommunications_checkData = $(".statisticalCommunications_datatable")
                    .dataTable()
                    .fnGetData().length;

                if (statisticalCommunications_checkData === 0) {
                    $('.foundData').hide();
                    $('.NoData').show();
                } else {
                    $('.NoData').hide();
            ...
            $('.btn_pdf').click(function() {
                var data_table = $(".statisticalCommunications_datatable").dataTable().fnGetData();
                $("#data_print2").val(JSON.stringify(data_table));
                $("#inquiry_form2").attr('action', '{{ route("statisticalCommunications.pdf") }}')
