...
<html lang="ar">
<head>
    <title>{{ __('lang.statistical_events_received') }}</title>
    <meta charset="utf-8">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-xl-4" style=" margin-top: 0%;">
                                    <p class="center_p">
                                        {{ __('lang.statistical_events_received1') }}
                                        <br>
                                        {{ __('lang.statistical_events_received2') }}
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <table class="table table-responsive-sm table-bordered table-striped incomingReports_datatable">
                                ...
                                <tbody>
                                    @foreach ($data as $elm)
                                        <tr>
                                            <td class="text-center text-data td_none_b"> {{ $elm->event }} </td>
