...
<html lang="ar">
<head>
    <title>{{ __('lang.typical_reports_places') }}</title>
    <meta charset="utf-8">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-xl-4" style=" margin-top: 2%;">
                                    <p class="center_p">{{ __('lang.typical_reports_places') }}</p>
                                </div>
                                ...
                                <tbody>
                                    @foreach ($data as $elm)
                                        <tr>
                                            ...
                                            <td class="text-center text-data td_none_b"> {{  rtrim($elm->gathering_type) }} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->address) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->carry_capacity) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->phone) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->no_roles) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->building_area) !!} </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
