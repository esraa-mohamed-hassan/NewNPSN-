...
<style>
    ...
    .title_header1{
        color:black; margin-top: 1.25rem !important;margin-right: -3%;font-size: 20px;
    }
    ...
    @media print {
        ...
        @page { size: A4 landscape;margin: 4mm 8mm 4mm 8mm;}
    }
    </style>

    <div class="form-group col-xl-12 text-center title_header1">
        <strong>{{ __('lang.typical_reports_places') }}</strong>
    </div>

    <input type="hidden" name="data" id="data_print">

    <div class="card-body">
        <table class="table table-responsive-sm table-bordered table-striped reportsPlaces_datatable"
...
@section('javascript')
    <script>
        $(document).ready(function() {
            ...
            var table = $('.reportsPlaces_datatable').DataTable({
                ...
                buttons: [{
                    ...
                    title: '<div class="title_header"><strong> {{ __('lang.typical_reports_places') }} </strong></div>',
                ...
                processing: true,
                ajax: "{{ route('typicalReportsPlaces.index') }}",
                columns: [{
                        data: 'id',
                        name: 'id',
                        orderable: false,
            ...
            $('.btn_pdf').click(function() {
                var data_table = $(".reportsPlaces_datatable").dataTable().fnGetData();
                $("#data_print2").val(JSON.stringify(data_table));
                $("#inquiry_form2").attr('action', '{{ route("typicalReportsPlaces.pdf") }}')
