            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <br>
                        <form method="POST" class="col-sm-12 col-md-12 col-lg-8 col-xl-7 needs-validation" novalidate action="{{ route('dalilEntity.update') }}">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="id" value="{{ $dalil_entity->id }}">
                            <div class="input-group mb-3">
                                <input class="form-control" type="text" placeholder="{{ __('lang.Dentity')}}" name="entity" value="{{ $dalil_entity->entity }}" required autofocus>
