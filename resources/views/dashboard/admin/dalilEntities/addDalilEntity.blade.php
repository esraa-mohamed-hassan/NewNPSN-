            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <br>
                        <form method="POST" class="col-sm-12 col-md-12 col-lg-8 col-xl-7 needs-validation" novalidate action="{{ route('dalilEntity.store') }}">
                            @csrf
                            @method('POST')
                            <div class="input-group mb-3">
                                <input class="form-control" type="text" placeholder="{{ __('lang.Dentity')}}" name="entity" value="" required autofocus>
