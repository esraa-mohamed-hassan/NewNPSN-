            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <br>
                        <form method="POST" class="col-sm-12 col-md-12 col-lg-8 col-xl-7 needs-validation" novalidate action="{{ route('operationData.store') }}">
                            @csrf
                            @method('POST')
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" type="text" placeholder="{{ __('lang.job')}}" name="job" value="" required autofocus>
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="cil-description c-icon c-icon-sm"></i>
                                    </span>
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" type="tel" placeholder="{{ __('lang.work_phone')}}" name="work_phone" value="" required autofocus>
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="cil-description c-icon c-icon-sm"></i>
                                    </span>
