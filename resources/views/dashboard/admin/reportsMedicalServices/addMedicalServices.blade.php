            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <br>
                        <form method="POST" class="col-sm-12 col-md-12 col-lg-8 col-xl-7 needs-validation" novalidate action="{{ route('medicalServices.store') }}">
                            @csrf
                            @method('POST')
                            <div class="input-group mb-3">
                                <input class="form-control" type="text" placeholder="{{ __('lang.hospital')}}" name="hospital" value="" required autofocus>
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" type="tel" placeholder="{{ __('lang.no_doctors')}}" name="no_doctors" value="" required autofocus>
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="cil-description c-icon c-icon-sm"></i>
                                    </span>
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" type="tel" placeholder="{{ __('lang.no_beds')}}" name="no_beds" value="" required autofocus>
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="cil-description c-icon c-icon-sm"></i>
                                    </span>
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" type="tel" placeholder="{{ __('lang.no_operating_rooms')}}" name="no_operating_rooms" value="" required autofocus>
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="cil-description c-icon c-icon-sm"></i>
                                    </span>
