                            ...
                            <table class="table table-responsive-sm table-striped table-bordered incomingReports_datatable">
                                ...
                                <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center text-data td_none_b"> {{ $data->time }} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($data->subject) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($data->procedures_npsn) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($data->procedures_authorities) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($data->result) !!} </td>
                                        </tr>
                                </tbody>
                            </table>
                        </div>
