                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="col-sm-12 col-md-12 col-lg-12 col-xl-12 needs-validation" novalidate
                                action="{{ route('incomingreport.update') }}">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="id" value="{{ $incoming_report->id }}">
                                    ...
                                    <select class="col-sm-10 col-md-8 col-lg-6 col-xl-10  selectpicker"
                                        ...
                                        @foreach ($entities as $entity)
                                            <option value="{{ $entity->entity_name }}"
                                                ...
                                                {{ $incoming_report->entity == $entity->entity_name ? 'selected' : '' }}
                                ...
                                <div class="form-group mb-3 col-xl-7" style="margin-right: -1.85%;">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input style="border-right: none;" class="form-control"
                                            data-date-format="yyyy-mm-dd" value="{{ $incoming_report->date }}" required
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control mytextarea" id="mytextarea" name="subject"
                                        required>{{ html_entity_decode($incoming_report->subject) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control mytextarea" id="procedures_npsn" name="procedures_npsn"
                                        required>{{ html_entity_decode($incoming_report->procedures_npsn) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control mytextarea" id="procedures_authorities"
                                        ...
                                        required>{{ html_entity_decode($incoming_report->procedures_authorities) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control mytextarea" id="result" name="result"
                                        required>{{ html_entity_decode($incoming_report->result) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
