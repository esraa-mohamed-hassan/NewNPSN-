                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="col-sm-12 col-md-12 col-lg-12 col-xl-12 needs-validation" novalidate
                                action="{{ route('recordingScenario.update') }}">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="id" value="{{ $recording_scenario->id }}">
                                    ...
                                    <select class="col-sm-10 col-md-8 col-lg-6 col-xl-10  selectpicker"
                                        ...
                                        @foreach ($event_types as $event_type)
                                            <option value="{{ $event_type->name }}" title="{{ $event_type->name }}"
                                                {{ $recording_scenario->event_type == $event_type->name ? 'selected' : '' }}
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea rows="4" cols="50" class="form-control" id="goal_achieved" name="goal_achieved"
                                        required>{{ html_entity_decode($recording_scenario->goal_achieved) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group mb-3">
                                    <label for="{{ __('lang.urgent_actions') }}">{{ __('lang.urgent_actions') }}</label>
                                    <textarea rows="4" cols="50" class="form-control" id="urgent_actions" name="urgent_actions"
                                        required>{{ html_entity_decode($recording_scenario->urgent_actions) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea rows="4" cols="50" class="form-control" id="creating_management_team"
                                        name="creating_management_team"
                                        required>{{ html_entity_decode($recording_scenario->creating_management_team) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea rows="4" cols="50" class="form-control" id="information_required" name="information_required"
                                        required>{{ html_entity_decode($recording_scenario->information_required) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea rows="4" cols="50" class="form-control" id="decision" name="decision"
                                        required>{{ html_entity_decode($recording_scenario->decision) }}</textarea>
                                    <div class="valid-feedback">
                                        {{ __('lang.looks_good') }}
                                    </div>
                                    <div class="invalid-feedback">
