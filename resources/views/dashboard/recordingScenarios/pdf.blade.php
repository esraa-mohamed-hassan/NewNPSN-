...
<html lang="ar">
<head>
    <title>{{ __('lang.scenario_results') }}</title>
    <meta charset="utf-8">
                            ...
                            <table class="table table-responsive-sm table-bordered table-striped incomingReports_datatable">
                                <thead>
                                    <tr class="incoming_tr">
                                        ...
                                        <th>{{ __('lang.goal_achieved') }}</th>
                                        <th>{{ __('lang.urgent_actions') }}</th>
                                        <th>{{ __('lang.creating_management_team') }}</th>
                                        <th>{{ __('lang.information_required') }}</th>
                                        <th>{{ __('lang.decision') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        <tr>
                                            <td class="text-center text-data td_none_b"> {{ $data->event_type }} </td>
                                            <td class="text-center text-data td_none_b"> {{ rtrim($data->goal_achieved) }} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($data->urgent_actions) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($data->creating_management_team) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($data->information_required) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($data->decision) !!} </td>
                                        </tr>
                                </tbody>
                            </table>
                        </div>
