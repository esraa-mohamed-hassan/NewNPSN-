...
@section('content')
    ...
    <style>
        ...
        #inquiries_responsible_datatable_filter {
            display: none;
        }

        #inquiries_responsible_datatable_length {
            display: none;
        }
                ...
                <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-xl-6">
                                    <i class="fa fa-align-justify"></i>{{ __('lang.inquiries_specific_responsible') }}
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="col-sm-12 col-md-12 col-lg-12 col-xl-12 needs-validation" novalidate action=""
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        <label for="{{ __('lang.name') }}"
                                            style="margin-left: 2%;">{{ __('lang.name') }}</label>
                                        <input class="form-control" type="text" placeholder="{{ __('lang.name') }}"
                                            name="name" value="" id="name" autofocus required>
                        ...
                        <div class="card-body hr_hide">
                            ...
                            <p class="p_text text-center hr_hide">{{ __('lang.responsible_results') }}</p>

                            <table class="table table-responsive-sm table-striped inquiries_responsible_datatable"
                                id="inquiries_responsible_datatable" style="display: none;">
                                <thead>
                                    <tr class="incoming_tr">
                                        <th style="width: 2%!important;">{{ __('lang.id') }}</th>
                                        <th>{{ __('lang.name') }}</th>
                                        <th style="width: 17%!important;">{{ __('lang.job') }}</th>
                                        <th style="width: 15%!important;">{{ __('lang.address') }}</th>
                                        <th style="width: 17%!important;">{{ __('lang.work_phone') }}</th>
                                        <th style="width: 25%!important;">{{ __('lang.phone') }}</th>
                                    </tr>
                                </thead>
                        ...
                        <div class="card-header header_buttons hr_hide">
                            <div class="row">
                                <div class="col-xl-6">
                                    <form id="form_printer" action="{{ route('specificResponsible.print') }}"
                                        method="POST">
                                        @csrf
...
@section('javascript')
    <script type="text/javascript">
        ...
        $("#btn-printer").click(function(event) {
            var allData = [];
            var data_table = $("#inquiries_responsible_datatable").dataTable().fnGetData();
        ...
        $("#btn_inqury").click(function(event) {
            ...
            if (name !== '') {
                ...
                $('#inquiries_responsible_datatable').hide();
                $('#inquiries_responsible_datatable').show();
                $('.hr_hide').show();
                $.ajax({
                    url: "{{ route('specificResponsible.store') }}",
                    "type": "POST",
                    headers: {
