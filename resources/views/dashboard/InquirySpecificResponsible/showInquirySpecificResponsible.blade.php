...
@section('content')
    <style>
        ...
        .responsibleInquiries_datatable {
            direction: rtl;
            margin-top: 0%;
        }
        ...
        .responsibleInquiries_datatable tr {
            font-size: 18px !important;
        }

        .responsibleInquiries_datatable td {
                ...
                <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12">
                    <div class="card-header header_buttons">
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <form id="inquiry_form2" action="{{ route('specificResponsible.pdf') }}"  method="POST">
                    ...
                    <div class="card card_print">
                        <div class="card-header noprint_content">
                            <div class="row">
                                ...
                                <div class="col-xl-2">
                                    <p class="center_p">{{ __('lang.responsible_results') }} </p>
                                </div>
                                <div class="col-xl-5">
                        ...
                        <div class="card-header print_content">
                            ...
                            <p class="centerprint_p print_content">{{ __('lang.responsible_results') }}</p>

                            <div class="row" style="float: right;">
                                <div class="form-group col-xl-5 portsaid_logo1">
                                    <img src="{{ url('assets/img/logos/port_said_logo.png') }}" class="portsaid_logo"
                        ...
                        <div class="card-body" style="overflow: auto;">
                            ...
                            <table
                                class="table table-responsive-sm table-bordered table-striped dataTable no-footer responsibleInquiries_datatable"
                                style="table-layout: fixed;">
                                <thead class="text-center">
                                    <tr class="incoming_tr">
                                        <th style="width: 2%">{{ __('lang.id') }}</th>
                                        <th style="width: 10%">{{ __('lang.name') }}</th>
                                        <th style="width: 18%">{{ __('lang.job') }}</th>
                                        <th style="width: 14%">{{ __('lang.address') }}</th>
                                        <th style="width: 20%">{{ __('lang.work_phone') }}</th>
                                        <th style="width: 27%">{{ __('lang.phone') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @foreach ($all_data as $key => $data)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center text-data"> {!! $data->address !!} </td>
                                            <td class="text-center text-data"> {!! $data->work_phone !!} </td>
