...
<html lang="ar">
<head>
    <title>{{ __('lang.typical_reports_operation') }}</title>
    <meta charset="utf-8">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-xl-4" style=" margin-top: 0%;">
                                    <p class="center_p">
                                        {{ __('lang.typical_reports_operation1') }}
                                        <br>
                                        {{ __('lang.typical_reports_operation2') }}
                                    </p>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $elm)
                                        <tr>
                                            ...
                                            <td class="text-center text-data td_none_b"> {{  rtrim($elm->name) }} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->job) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->address) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->work_phone) !!} </td>
