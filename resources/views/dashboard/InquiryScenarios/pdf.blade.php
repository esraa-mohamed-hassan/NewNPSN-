                        ...
                        <div class="card-body">
                            <table class="table table-responsive-sm table-bordered table-striped incomingReports_datatable">
                                ...
                                <tbody>
                                    @foreach ($data as $elm)
                                        <tr>
                                            <td class="text-center text-data td_none_b"> {{ $elm->event_type }} </td>
                                            <td class="text-center text-data td_none_b"> {{ rtrim($elm->goal_achieved) }} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->urgent_actions) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->creating_management_team) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->information_required) !!} </td>
                                            <td class="text-center text-data td_none_b"> {!! rtrim($elm->decision) !!} </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
