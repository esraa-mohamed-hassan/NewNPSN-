...
@section('content')
    <style>
        ...
        .scenarioInquiries_datatable tr {
            font-size: 18px !important;
        }

        .scenarioInquiries_datatable td {
                    ...
                    <div class="card card_print">
                        <div class="card-header noprint_content">
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <p class="center_p">{{ __('lang.reports_scenario') }} </p>
                                </div>
                                <div class="col-xl-4">
                        ...
                        <div class="card-header print_content">
                            ...
                            <p class="centerprint_p print_content">{{ __('lang.reports_scenario') }}</p>
                        ...
                        <div class="card-body" style="overflow: auto;">
                            <table
                                class="table table-responsive-sm table-bordered table-striped dataTable no-footer scenarioInquiries_datatable"
                                style="table-layout: fixed;">
                                <thead>
                                    <tr class="incoming_tr">
                                        <th style="width: 10%">{{ __('lang.event_type') }}</th>
                                        <th style="width: 18%">{{ __('lang.goal_achieved') }}</th>
                                        <th style="width: 14%">{{ __('lang.urgent_actions') }}</th>
                                        <th style="width: 20%">{{ __('lang.creating_management_team') }}</th>
                                        <th style="width: 27%">{{ __('lang.information_required') }}</th>
                                        <th style="width: 36%">{{ __('lang.decision') }}</th>
                                    </tr>
                                </thead>
                                ...
                                @foreach ($all_data as $key => $data)
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center"> {{ $data->goal_achieved }} </td>
                                            <td class="text-center text-data"> {!! $data->urgent_actions !!} </td>
                                            <td class="text-center text-data"> {!! $data->creating_management_team !!} </td>
                                            <td class="text-center text-data"> {!! $data->information_required !!} </td>
                                            <td class="text-center text-data"> {!! $data->decision !!} </td>
                                        </tr>
                                    </tbody>
