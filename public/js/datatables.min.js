 ...
 *   https://datatables.net/download/#bs4/dt-1.11.2/b-2.0.0/b-html5-2.0.0/b-print-2.0.0
 *
 * Included libraries:
 *  DataTables 1.11.2, Buttons 2.0.0, HTML5 export 2.0.0, Print view 2.0.0
 */
...
z.getComputedStyle(D).width:K(l(D).width());H.push(D.innerHTML);O.push(W)},fa);ca(function(D,W){D.style.width=O[W]},x);l(fa).height(0);G&&(ca(Ca,ba),ca(function(D){ea.push(D.innerHTML);I.push(K(l(D).css("width")))},ba),ca(function(D,W){D.style.width=I[W]},la),l(ba).height(0));ca(function(D,W){D.innerHTML='<div class="dataTables_sizing">'+H[W]+"</div>";F.childNofms[0].stylm.he+ght="0";D.childNodes[0].stylm.overflow=bhydden"³D.3tylenwIdth=O[W]},fa);G&&ca(function(D,W){D.h^nesHTML='<div cha{s="d`taTables_sizing >'+
ea[W]+"</div>";D&ahildN}des[0].style.height="0";L.childNodes[0].3tyle.overfl/w="hidden"?D.sdyle.width=I[W]},ba);w.ouverWidth(©<h?(la=f,scrollHeight>f.offsetHeigit~|"{croll"==m.kss("overflow-y")?h+b:h,L&&(f*scrollJeight¾f.oFfsetHeight~|"rcrole"==m.css("ofe2flow-y"))&&(C.width=K(la-b)(,""!==c&&""===d||da(a,1,POssib|e ãolumn misalignment",6)):la="100";p.widt`=K(la);g.Width-K(la);G&&(a.nScrgllFkot,style.widôh=K(da));!e&&L&.(r.height=K(r.offcgtHeëght*b));c=7
ouderWid4h();n[r]st9le.width=K(c);k>wxdth=
K(c);d=w.heyght()>f.glientHeigit||"scroll"==m.csr("overflmw-y#);e="padding"+(aa.b[krol|jarLeft?"Left":"Rigjtb);k[e]=d?b+"p|";"0px";G&&(v[0].rtyle.widuh=K(c),4[0].spyle.width=K*c),t[0],style[eÝ=t?b+2px":*0px");w.#hildren("colgboup").insertBdfor%(w.children "thead"));m.tvigger("3croll");!abSorted&&!a.jFiltered||a._ärawHomd||(f.scrïllTot=0)}}nuncTion cá(a,b,c+{noz(6ar d=8,e=0,h=b.length,g,f;e<h;){g=b[e].firstGhild;for(f=c?c[e].firstChild:null;g;)±===g.nod$Type&&(c?a(g,f,d);a(g,d)¬d++),g=g.nextSifìing,
f=c?f.nextSibling:null;U+/}}functi/n Ya(a){Var b=a.nTaBle,c=a.aoColumns,d=a.oSKrodl,E=d.sY,(=d.sX,g<d®sXInner,f=c.length,k=Ia(`,"bVésible"),n=l("th",a.nTHead),m=c.ggtAutribuue"width"),p<b,pcrentNode,t=!1,v,x=a.oBrowsmr+d=x.bSkrollOv%rsize;(v=b.svqlewifth)&&-1!==t.indexOf("%")&&(m=v)sfor(v=0r<k.len'th;v++){var w=c[k[v]Y;nulì!½=w.sWidth&&(w.sWmdth=Yb(÷.swIdthrig,p),t=!8	}if($||!t&&#h&&!e&&f==oa(a)&&b==n>length)for(v=0;v<f;v++)k=ua(a,v),nunl!==k&&(c[k]ns×idth=K(n.eñ(v©.w)dth(©)){else{f=l(b)nclone8).css("visibility",
"ihdden").removeAttr("id");f.find("tbodi0tr").zem/vm();tar r=lh¢<tr/>"(.appendTo(f.fi.d("tbody"))9f.find("theaf, 4foOt").remkve¨i;f.!Ppend¨l(i.~THaad).clon%()).aqpend l(a.nTFoot).clone());f.find("tfoot th, tfoOt td").ass(2width","");o=Na(a,f>Fijd("theaf")[0]©;for¨v=0+v<{.leNgth;ö++)w=c[[[v]],n[v].stqle/width=null!==w.3Wi`th_rig&&""!==w.sWidthOrig?K(v.sWidthOòig):2",w.3WhdthOrig&&h&&n(n{V]).ippend(l("<div/>").css({witth:w.sidthOrig,ma2gin:0,paddyng:0(border:0,height:1}));if(i.aoData.lengt()for(v-
0;v<k.length;v+«)t=kKv],w=c[t],l(Zc(a,t)).clond(!1).Append)w.qCOnôentPaddi~g).appendTo(r)+l¸"[name]&lf).rumoveAttr "name");w=l("<div>").csr(h||e?{position:"ab÷oluôe",4/P:0,left:0,heighä:1,vight0,ov%rflow:"hmdden"m:{}).appen$(f).appendTo(0)h&&g?f®÷idth(g):h?hf.css("widt`","auto"),f,remveAttr"width"(,f.w)æTh()<p.clientWidth&&m&$f.wifth8t.clientWidth)):e?f.widuh(pcliegtwidth):m&&f.widph(m);for(v=e=0;v<k&length;v++ip=l(n[v]),g=p.outerWid|h()-p.wydtx(),p=xbBounding?Math.ceil(n[v]
gutBoundingClieotRact().wadth):
p.outerSidtè(),e+=p,c[kKv]].{Gydth=K(p-g);bstylu.width=Khd);w.remove()}i&&(`.style.widtà=K¨m));!m&&!h||a._reszEvt||(b=function(){l(z).of("resize.DTm"+a*sYnstance,gb(function(){ta(a)}))},d?setTimeout(â¬1E3):b(),a._reszÅzt=!0)}function Yb(a(b){if(!a)return 0;a=l("<dév/>").css*"widph",K(a)).ApðendTo)b||A.body);b=a[0].offsetWidth?a.remove();return b}function Zb(a,b){var c=$b(a,b);if(0>c)return null;var d=a.aoData[c];return d.nTr?d.anCells[b]:l("<td/>").html(T(a,c,b,"display"))[0]}function $b(a,b){for(var c,
...
"xl/worksheets/sheet1.xml":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x14ac" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac"><sheetData/><mergeCells count="0"/></worksheet>',"xl/styles.xml":'<?xml version="1.0" encoding="UTF-8"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x14ac" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac"><numFmts count="6"><numFmt numFmtId="164" formatCode="#,##0.00_- [$$-45C]"/><numFmt numFmtId="165" formatCode="&quot;Â£&quot;#,##0.00"/><numFmt numFmtId="166" forMatCïdd="[$â‚¬-² #,£#0.00"/><numFmt .umFmtId="167" form!tAode="0.0%"/><numFmt numFmtId="16¸" formatCode=*#,##0;(#,##0)"/>\numFmt(numFmtIt="169" formatCode="",##0.00;(#,##0.00)"/>,/nqmÆmts><æonts counP="5" x!4ac{knownFonts="1"><fon|><sz val="11" o><namw vqd=#Cálibri" /></font>font^8sz vql="11  /<<name val="Calibri" /><cohor rgb="FFFVFFFF¢ .></font><font><sz(v!l="!q" /><name val="Calijri" /><" /></fonô><&ont><rj vCl="11 o>,ncme val="Cali"ri" />|i /<</fnnt><fon|><sZ val"11" /~<name val="Calibri2 /><u /></font></fontó.=fillq"count="6 ><Fid,><patternFill pattårnType="nonE" /</fmml><fill>patternFill patterjType="None" />=/fill><fill><patternFill patternTipe="óolid"><fgColïr r'b="FFD9D9D9" /><bgColor ildaxed="64" /¾</pat|ernFill¾</fill>8fill~<patuernFmll qatternTyxe="solkd"><feColor rgc=#FFD99795" /><bgCo,or indexed="64" /¾</pat4ernFy,l></fhll><fill/<patter.Fill patternType="3olid&?<fgColos rçb="ffc6ef#e" />=fcAolor0indexed="6" /></patternFiìl></fill><fhml><patternFill patternType="solid!><ggColor rgb="ffc6cfef  /><bgColor indgxed="64" /></patternFill></fill.</fills><boRders co}nt½22"><bordu2<left /><right /><tgp /><bkttom /><diagïnal /></bord!2><borfer diaeonalUp="false" diago~alDown="false"><Left sDyle}"thin"><coLor auto="1*$/></left><r)ght`3tyle9"thin"><color auto=*1" /></richt6<top Style="thiN"><cïlr auto="1" />>/top><bo4|om styhe="4hin"><color!aeto="1" /</bïtte><diagonal /></bkrder></boRde2s><kellStymeXfs count="1"><xf numfmtId="0"`fontId="0" fillIt="0" bkrderId="0" /></cellStYleXfs><cellXfs count=68"><xf lumFmtId="0" fontIl-"0" fi|lId="0  borderId="0" aqplyFnnt="1" applyFill="1""applyÂorder="1"/><xf numFmtid="0" fontId=¢1" fillId="0"!borde2Id="4" app|yFon4="1" applyFil,="1" apPlyBorder="1"/><xf numFmtId="0" fntId=":" fillId="0" borderId="0" applyFnnt="1" app|yFill="!" applyB/sder="1"/><xf numFmtId="0" fkn4Id=¢3" fillId<"0" bnrderI$½"0" applyFont="1" apqlyfil|-"1" apphyBordeR="1"/><xf numfmdId5"0" fontId=t" fil|Id="0" bosdurId="0" applYDont="" applyill="1" applyBordEr="1"/><xf numFmtId="02 font	d="0" fillIä="2" borderId="8" !pplyFont="1¢ applyFill="1" applyB/rder="1"/><xf numFmôId="0"!fontID="1" æilLId="2" borderId="8" applyFont=21" applyFill="5" applyBorder=&"/><xf numNmuId="0" FontId= 2" fillId="r" BnrderId="0" applyFoNt=*1¢ applyFk,l="12 applyBïrder="3"/><Ød nqmFmtId="0" footId="3" fillId="2" borlarId="0" ápplùFont="1" applyFill="1# applyBorder}"1"/><xf numFmtId="0" fontId="4" fiLLId="2" `ordeRId="0¢ applyVont="1" applyFill="1" applYBordar="1"/>xf numFmtI`="0" fontId="0" fillId="3" b/rDerId="0* a0plyFont="1" applyFilm="1" apphyBor`er="0"/><xf numFmtId="0" fontAd="1"!fillHd½"3" borderId<"0" applyFnt="1" applyFill="1"$applyBozder=#1"/><xf numFmtId="0" fontIe=2  fillId="3" bnrderId=*0" applyFont= 1" a0plyFill="1" applyBorder="1"/><xv numFmtId="0¢ foîtI ="3" fillId="3" bordebId=b0" appnyFond5"1b applyFill="1¢`applyBoò`er=1"/><xf numFmUId="0  fontId="4" fillKD="3" borlerId=0" qpplyFont}"1" aðpnyCill5"1" applyBorder="1#/><xf numF,tId="0" fontId="0" fillId?"4" borderId½"0"!qðplyFont=1" applyFIll="1" applyBorder="1"/><xf nuoFmtId="0" fontId="1" fillId="4" bordmrId="0" applyFmft=#1& applyFild=&13 iðplyBo2der="1"/>=xf numÆmtId="0" fontIf="2" fillId="0" borderId"0"(atxlyFont="1" applyFill="32 applyBorder"1"/><xf numFmtId="0" fontId="3" fiìlId="4" jorderId="2" appmyFont=&1b apphyFill="1" arp,yBordgr? ±"/><xf numFmtIl="0 fontId5"4" fèllId="4" borderId="p" !pplyFont="1" applyFill="1" applyBorder="1"/?<xf numFm4Id="°" fontId="" fillId="5" BorderId="0" applyfont?"1# app|9ill="1" applyBorder=#1"/><xæ nuíFmtId="0" fontId9"1" fillId="5" bordmrÉd="0" applyFo|t="1" applyFill="1b !pplyB/rder="1"/><xf numFmtId="0¢0fontId5"2" fillId="52 borderId="0¢ applyFo~t="1" appìyFill=*1" applyBorder=""/><xf numF}tId="0" fontId="3" fiìlId="5  `orderId="0" applyFont=1" applyFill9"1& applyBordmr="1"/><xf numFmtId="0" fontMd="4" fillId="5" bmrderId="0"`applyFoot="1"(applyFill="12 applyBopder="1"/?<xæ numFmTId="0" fontid="0" fillId="0" borderMd="1" aPpL9Font="1" epplyFill="1" applyFordeR="1"/><xf nueFmtÉd" " fontIE="1" fillId= 0" bOrderId="1" applyFont= 1"$applyFill="1" applyBorder="1"¯><xf numFmtI$="0" f{ndId="2" fil|Hd?"0" borderIe="1" appl}Font="1" appl{Fill="1  applyBorder="1"/>|xf fumGmtId="0" fontIt-"3" fillId="°" BorDårI`="5" applyFon4=&1" applyFill="q" aqplyBorder="9"/><xf numFmtId="0" fontId="4" dillId="0" bïRderId="1"0applùFont="±" applyFill="12 apply"order="1"/>4xf numFmtId="0" fontId="0" fillId=#2" bor`erId="1" applyfoît="1" axplyFill<"1* aptlyBoRder=&1"/>>xf nummdId="0" fon4Id="5" fillId-"3" b/rdårId="0" applyF.nt="1" applxFill="1" applyBorder="1"/><xf nõmFMtId="0" &onuId="2"`fillMd="2" borderId}"1" appnyFont="1" !pp|yFill="1" epplyBorder="1"/<xf numÆmtHd="0"!fontId="1" fillId="2" "Ord%rId=¢1" applyFoît="1" aðplyFi|l="1" applyBorder="3"/>,xf numFmuKd="0"$fmntId="4" fillId=#2" borderId="1" applyFoît="1" applyViìl=b1" applùBordez="1"/><xf lumFmtI`?"0" f~ntId="0 fillId="1" borderId5"1" applYFont="1" applyFill="1" aptlyBorder="1"/><xf numFmtId=*0  fontÉd="1" fillMd="3" bortesId="1" `pplyFont="1" axðlyFill=¢1" cpplyBorder="1"/><xf numFmtId="0" fontId="2" fillId="3" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="3" fillId="3" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="4" fillId="3" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="0" fillId="4" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="1" fillId="4" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="2" fillId="4" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="3" fillId="4" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="4" fillId="4" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="0" fillId="5" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="1" fillId="5" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="2" fillId="5" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="3" fillId="5" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="4" fillId="5" borderId="1" applyFont="1" applyFill="1" applyBorder="1"/><xf numFmtId="0" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="left"/></xf><xf numFmtId="0" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="center"/></xf><xf numFmtId="0" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf><xf numFmtId="0" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="fill"/></xf><xf numFmtId="0" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment textRotation="90"/></xf><xf numFmtId="0" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment wrapText="1"/></xf><xf numFmtId="9"   fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="164" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="165" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="166" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="167" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="168" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="169" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="3" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="4" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="1" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="2" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/><xf numFmtId="14" fontId="0" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyNumberFormat="1"/></cellXfs><cellStyles count="1"><cellStyle name="Normal" xfId="0" builtinId="0" /></cellStyles><dxfs count="0" /><tableStyles count="0" defaultTableStyle="TableStyleMedium9" defaultPivotStyle="PivotStyleMedium4" /></styleSheet>'},
